...
public class AboutUs extends JFrame {
	...
	public AboutUs() {
		...
		JLabel l6 = new JLabel("Developed By : Devendra Singraul");
		...
		JLabel l8 = new JLabel("Twitter : @devendra_singraul");
		l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		l8.setBounds(99, 241, 600, 34);
		contentPane.add(l8);
		
		JLabel l10 = new JLabel("Github : https://github.com/D51947403");
		l10.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		l10.setBounds(99, 286, 600, 34);
		contentPane.add(l10);

		JLabel l9 = new JLabel("Instagram : @devendra_singraul");
