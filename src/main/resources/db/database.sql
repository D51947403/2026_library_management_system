...
CREATE SCHEMA if not exists  2026_library_management_system ;

use  2026_library_management_system;
...
insert into account values ('devendra', 'devendra singraul', 'devendra123','first vehicale','Hero Honda');
